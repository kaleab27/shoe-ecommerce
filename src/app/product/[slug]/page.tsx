...
// The slug is going to be the id of the product which will then be used to fetch the full product detail
          ...
          <div className="relative aspect-square bg-amber-50 overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-between px-4">
              <Button
                variant="outline"
                size="icon"
                className="rounded-full bg-white/80 dark:bg-gray-950/80 hover:bg-white hover:dark:bg-gray-950"
                onClick={prevImage}
              >
                ...
                {product.colors.map((color) => (
                  <div key={color} className="flex items-center">
                    ...
                    <Label
                      ...
                      className="rounded-md border border-muted px-3 py-2 hover:border-amber-800 peer-data-[state=checked]:border-amber-800 peer-data-[state=checked]:bg-amber-50 peer-data-[state=checked]:text-gray-950"
                    >
                      {color}
                    </Label>
                  </div>
          ...
          <Tabs defaultValue="details">
            ...
            <TabsContent value="details" className="pt-4">
              ...
              <p className="text-muted-foreground mt-4">
                The Oxford Classic is a timeless dress shoe that has been a
                staple in men&apos;s fashion for centuries. Our version combines
                traditional craftsmanship with modern comfort features to create
                a shoe that looks as good as it feels.
              </p>
            </TabsContent>
